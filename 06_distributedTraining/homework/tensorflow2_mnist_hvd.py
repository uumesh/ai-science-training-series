...
if(hvd.rank()==0):
  output_file = open('hw6_{}.dat'.format(hvd.size()),'w')
for ep in range(args.epochs):
    ...
    if(hvd.rank()==0):
      ...
      result = np.array([training_acc,test_acc])
      np.savetxt(output_file,result,fmt='%1.5f',newline=" ")
      output_file.write("\n")
